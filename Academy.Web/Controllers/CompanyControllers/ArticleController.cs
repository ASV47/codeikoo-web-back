...
namespace PresentationLayer.Controllers
{
	...
	public class ArticleController(IServiceManager _serviceManager) : APIBaseController
	{
		[HttpGet]
		...
		{
			var imageUrl = DocumentSettings.UploadFile(dto.Image, "Articles");
		...
		public async Task<ActionResult> Update(int id, [FromForm] CreateArticleDTO dto)
		{
			...
			if (dto.Image != null)
			{
				...
				// رفع الصورة الجديدة
				finalPath = DocumentSettings.UploadFile(dto.Image, "Articles");
			}
			else
			{
